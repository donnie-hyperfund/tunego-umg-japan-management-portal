      ...
      <div className="relative h-48 md:h-56 overflow-hidden">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 sm:px-8 md:px-12 lg:px-16 h-full flex items-center">
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white">Live Events Management</h1>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-8 md:space-y-16">
          <section>
            <div className="mb-4 md:mb-6">
              <h2 className="text-xl md:text-2xl font-bold text-white mb-2">Events</h2>
